...
export HOMEDRIVE='/c'
export HOMEPATH='/Users/humphrig/projects'
...
# add mingw and mysys paths to end of PATH environement variable to get
# c compiler as well as linux utilities that are not included in git bash
PATH="${PATH}:/c/MinGW/msys/1.0/bin:/c/MinGW/bin:/c/MinGW/msys/1.0/local/bin"
